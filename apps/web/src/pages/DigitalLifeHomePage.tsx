...
export function DigitalLifeHomePage() {
  ...
  return (
    <main className="home-page home-page--immersive digital-life-home">
      ...
      >
        ...
        <div className="digital-life-actions" aria-label="和飞马互动">
          <Link
            className="digital-life-actions__game"
            to="/game"
            hash="start"
            aria-label="开始游戏：30 秒补给雨"
          >
      ...
      <section className="digital-life-continuity" aria-labelledby="growth-title">
        ...
        <div className="digital-life-continuity__activity">
          ...
          <Link to="/companion" aria-label="进入飞马对话">
            <span>聊聊</span>
