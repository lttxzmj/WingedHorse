...
| `apps/web/public/brands/bluebox/pillow-n2.webp` | 领取半屏产品图 | 用户提供的枕头产品图压缩导出。画面印字为「蓝盒子 / BLUE BOX / N2」。界面品牌字样只复用这些印字，不另写品名或广告句。公开活动前需确认授权与使用期限 |
| `apps/web/public/brands/bluebox/welfare-qr.svg` | 领取半屏演示码占位 | 仓库内演示二维码，须标「演示码」；不得把真实个人企微码提交进公开仓库 |
