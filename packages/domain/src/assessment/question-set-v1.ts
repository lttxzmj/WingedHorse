...
export const questionSetV1: QuestionSet = {
  ...
  questions: [
    {
      id: "q1", scene: "早上起床", prompt: "周一早上，闹钟响到第三遍，你——", scored: true,
      options: [
        ...
        { id: "d", label: "脑子里过了一遍三个请假理由，身体还是起来了", effects: { energy: -3, engine: -1 } }
      ]
    },
    {
      id: "q2", scene: "通勤路上", prompt: "地铁上有人外放短视频，声音巨大，你——", scored: true,
      options: [
    ...
    {
      id: "q3", scene: "到工位", prompt: "打开电脑，看到 99+ 条未读消息，你的第一反应是——", scored: true,
      options: [
    ...
    {
      id: "q4", scene: "早会", prompt: "领导说“我简单说两句”，然后讲了 40 分钟，你——", scored: true,
      options: [
    ...
    {
      id: "q5", scene: "上午干活", prompt: "上午的工作节奏通常是——", scored: true,
      options: [
        ...
        { id: "d", label: "被消息和会议切碎，一天下来不知道干了啥", effects: { engine: -3, chaos: 1 } }
      ]
    },
    {
      id: "q6", scene: "午休", prompt: "午休时间你一般——", scored: true,
      options: [
    ...
    {
      id: "q7", scene: "下午突袭", prompt: "下午三点，老板突然说“这个今晚要”，你——", scored: true,
      options: [
    ...
    {
      id: "q8", scene: "甩锅现场", prompt: "隔壁组同事在群里把锅甩给了你，你——", scored: true,
      options: [
    ...
    {
      id: "q9", scene: "摸鱼时刻", prompt: "摸鱼的时候，你通常在想——", scored: true,
      options: [
        { id: "a", label: "自己的事：副业、学习计划、健身安排", effects: { engine: 2, direction: 2 } },
    ...
    {
      id: "q10", scene: "下班点", prompt: "到了下班点，活儿干完了，但办公室没人走，你——", scored: true,
      options: [
    ...
    {
      id: "q11", scene: "加班", prompt: "加班到晚上九点，你的状态是——", scored: true,
      options: [
    ...
    {
      id: "q12", scene: "深夜回家", prompt: "深夜回家的路上，你脑子里最常出现的是——", scored: true,
      options: [
        { id: "a", label: "今天推进了什么，离目标又近了一步", effects: { direction: 3, engine: 1 } },
    ...
    {
      id: "q13", scene: "睡前刷手机", prompt: "睡前刷手机，你的画风是——", scored: true,
      options: [
    ...
    {
      id: "q14", scene: "周日晚上", prompt: "周日晚上，想到明天要上班，你——", scored: true,
      options: [
    ...
    {
      id: "q15", scene: "发薪日", prompt: "发工资那天，你的真实感受是——", scored: true,
      options: [
    ...
    {
      id: "q16", scene: "畅想未来", prompt: "想象一年后的自己，你看到的画面是——", scored: true,
      options: [
        ...
        { id: "d", label: "画面里工位是空的，我也不知道我去哪了", effects: { direction: -3, chaos: 1 } }
      ]
    },
    {
      id: "q17", scene: "诚实坦白局", prompt: "以下哪句最像你？", scored: false,
      options: [
        { id: "a", label: "我上班从未产生过“不想干了”的念头", effects: {}, easterEgg: "牛马浓度存疑，你是不是老板派来的？要不要诚实一点再想想 😏" },
